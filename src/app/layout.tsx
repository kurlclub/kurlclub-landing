...
export const metadata: Metadata = {
  title: {
    ...
    default: 'KurlClub - Gym Management Software | Fitness Studio Management Platform',
  },
  description: 'KurlClub is the leading gym management software in India & GCC. Manage members, attendance, payments & trainers for gyms, yoga studios, dance classes & martial arts. Book a demo today!',
  ...
  openGraph: {
    title: 'KurlClub - Gym Management Software | Fitness Studio Management Platform',
    description: 'Leading gym management software for India & GCC. Manage members, attendance, payments & trainers. Perfect for gyms, yoga studios, dance classes & martial arts.',
  ...
  twitter: {
    ...
    description: 'Leading gym management software for India & GCC. Book a demo today!',
  },
  appleWebApp: {
    title: 'KurlClub',
    capable: true,
            ...
            __html: JSON.stringify([
              {
                ...
                "name": "KurlClub",
                "description": "Gym management software for fitness studios, gyms, yoga studios, dance classes and martial arts centers in India and GCC",
                "url": "https://kurlclub.com",
              ...
              },
              {
                ...
                "name": "KurlClub",
                "url": "https://kurlclub.com",
                "description": "Leading gym management software provider for India and GCC markets",
                "areaServed": ["India", "UAE", "Saudi Arabia", "Qatar", "Oman", "Bahrain", "Kuwait"],
                "serviceType": "Gym Management Software",
                "knowsAbout": ["gym management", "fitness studio software", "yoga studio management", "dance studio software", "martial arts management"]
              },
              {
                "@context": "https://schema.org",
                "@type": "FAQPage",
